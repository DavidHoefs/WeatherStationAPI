...
namespace WeatherStationAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ITemperatureSensorData, TemperatureSensorData>();
            services.AddTransient<IWindData, WindData>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(x =>
            {
                x.SwaggerEndpoint("/swagger/v1/swagger.json", "WeatherStationAPIv1");
            });
