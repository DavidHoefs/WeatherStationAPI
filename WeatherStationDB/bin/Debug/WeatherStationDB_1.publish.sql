...
GO
PRINT N'Creating [dbo].[spTemperatureSensor_GetData]...';
...
BEGIN
SET NOCOUNT ON;
	SELECT Temperature,TimeCaptured
	FROM dbo.TemperatureSensor;
END
RETURN 0
GO
PRINT N'Creating [dbo].[spTemperatureSensor_UploadData]...';
...
INSERT INTO dbo.TemperatureSensor (Temperature,TimeCaptured)
VALUES (@Temperature,@TimeCaptured);
